  ...
  const sampleReceipts: Receipt[] = [
    {
      ...
      items: [
        { id: 'item_1', name: 'Basmati Rice Premium', quantity: 5, unit: 'kg', unitPrice: 110, lineTotal: 550 },
        { id: 'item_2', name: 'Sunflower Cooking Oil', quantity: 2, unit: 'litres', unitPrice: 160, lineTotal: 320 },
        { id: 'item_3', name: 'Toor Dal Grade A', quantity: 2, unit: 'kg', unitPrice: 140, lineTotal: 280 },
      ],
      subtotal: 1150,
      discount: 50,
      tax: 55,
      ...
      grandTotal: 1155,
      currency: 'INR',
      transcript: 'Basmati rice 5 kg at 110, Sunflower oil 2 litres at 160, Toor dal 2 kg at 140, discount 50 rupees, GST 5 percent.',
      createdAt: new Date().toISOString(),
    },
    {
      id: `demo_rcpt_2`,
      ...
      items: [
        { id: 'item_4', name: 'Wireless Bluetooth Earbuds', quantity: 1, unit: 'pcs', unitPrice: 1499, lineTotal: 1499 },
        { id: 'item_5', name: 'Type-C Braided Fast Cable', quantity: 2, unit: 'pcs', unitPrice: 250, lineTotal: 500 },
      ],
      subtotal: 1999,
      discount: 100,
      tax: 341.82,
      ...
      grandTotal: 2240.82,
      currency: 'INR',
      transcript: 'Bluetooth earbuds 1 piece at 1499, Fast cable 2 pieces at 250 each, discount 100 rupees, GST 18 percent.',
      createdAt: new Date().toISOString(),
    },
  ];
