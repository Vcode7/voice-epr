...
export function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-card/90 backdrop-blur-lg border-t border-cardBorder px-2 py-1.5 flex items-center justify-around shadow-2xl no-print">
      {NAV_ITEMS.map((item) => {
